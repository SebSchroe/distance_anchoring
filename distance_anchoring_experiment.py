...
# distance_anchoring.test(sub_id=sub_id, block_id=1, task_id=1, n_reps=1, isi=2)
...
distance_anchoring.training(sub_id=sub_id, block_id=3, task_id=1, n_reps=10, isi=2)
