...
distance_anchoring.test(sub_id=sub_id, block_id=1, task_id=2, n_reps=2, isi=0.5)
...
# distance_anchoring.training(sub_id=sub_id, block_id=3, task_id=2, n_reps=15, isi=2)
