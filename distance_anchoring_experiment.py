...
#block_id, task_id = distance_anchoring.set_ids(cond_id=cond_id, block_id=1)
#distance_anchoring.test(cond_id=cond_id, sub_id=sub_id, block_id=block_id, task_id=task_id, n_reps=15, isi=0.3) # n_reps of 8 equals 88 stimuli in condition 1, n_reps of 15 equals 90 stimuli in condition 2
#freefield.flush_buffers(processor='RX81')

# block 2: test visual
# block_id, task_id = distance_anchoring.set_ids(cond_id=cond_id, block_id=2)
...
#block_id, task_id = distance_anchoring.set_ids(cond_id=cond_id, block_id=3)
...
#block_id, task_id = distance_anchoring.set_ids(cond_id=cond_id, block_id=4)
...
#block_id, task_id = distance_anchoring.set_ids(cond_id=cond_id, block_id=5)
#distance_anchoring.training(cond_id=cond_id, sub_id=sub_id, block_id=block_id, task_id=task_id, n_reps=90, isi=2) # 90 trials with 2 seconds isi equals 180 seconds (3 minutes) testing
#freefield.flush_buffers(processor='RX81')

# block 6: visual unlimited test
block_id, task_id = distance_anchoring.set_ids(cond_id=cond_id, block_id=6)
distance_anchoring.test(cond_id=cond_id, sub_id=sub_id, block_id=block_id, task_id=task_id, n_reps=8, isi=0.3) #n_reps of 15 equals 90 stimuli in condition 1, n_reps of 8 equals 88 stimuli in condition 2
freefield.flush_buffers(processor='RX81')
